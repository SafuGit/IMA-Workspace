...
def build_agy_prompt(video_data: dict[str, Any], mode: str = "full") -> str:
    ...
    if mode == "hooks_only":
        return f"""/video-personalization /safwan-voice /cold-outreach /spam-word-checker
...
""".strip()
    ...
    prompt = f"""/fylint-agency /video-personalization /safwan-voice /cold-outreach /influencer-marketing /spam-word-checker
